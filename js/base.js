    ...
    this.setCodeHighlighting = function() {
        ...
        function prettifyCode() {
            ...
            switch (hltheme) {
                ...
                case 'desert':
                    setCodeBefore();
                    require(['codeDesert'], function() { setPrettifyCopy(); });
                    break;
                case 'sunburst':
                    setCodeBefore();
                    require(['codeSunburst'], function() { setPrettifyCopy(); });
                    break;
                case 'obsidian':
                    setCodeBefore();
                    require(['codeObsidian'], function() { setPrettifyCopy(); });
                    break;
                case 'doxy':
                    setCodeBefore();
                    require(['codeDoxy'], function() { setPrettifyCopy(); });
                    break;
                default:
                    cnblogsCode();
                    break;
